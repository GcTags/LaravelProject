                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="ProductName" id="ProductName"
                                    ...
                                    value="{{ old('ProductName') }}" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea type="text" name="ProductDescription" id="ProductDescription"
                                    class="form-control  @error('ProductDescription') is-invalid @enderror"
                                    value="{{ old('ProductDescription') }}" autofocus>
                                        </textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="Category" class="custom-select" id="Category"
                                    lass="form-control @error('Category') is-invalid @enderror"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea type="text" name="Price" id="Price"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea type="text" name="Stock" id="Stock"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="Status" class="custom-select" id="Status"
                                    lass="form-control @error('Status') is-invalid @enderror" value="{{ old('Status') }}"
                                    autofocus>
                                    {{-- <option selected>Choose...</option> --}}
